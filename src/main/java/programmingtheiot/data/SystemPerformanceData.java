...
public class SystemPerformanceData extends BaseIotData implements Serializable
{
	...
	protected void handleUpdateData(BaseIotData data)
	{
		if (data instanceof SystemPerformanceData) {
			SystemPerformanceData aData = (SystemPerformanceData) data;
			this.setCpuUtilization(aData.getCpuUtilization());
			this.setDiskUtilization(aData.getDiskUtilization());
			this.setMemoryUtilization(aData.getMemoryUtilization());
		}
	}
